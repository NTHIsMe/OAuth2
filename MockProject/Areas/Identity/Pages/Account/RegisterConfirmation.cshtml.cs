    ...
    public class RegisterConfirmationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string email, string returnUrl = null)
        {
            ...
            if (DisplayConfirmAccountLink)
            {
				...
				string body = $"Please reset your password by <a href='{HtmlEncoder.Default.Encode(EmailConfirmationUrl)}'>clicking here</a>.";

				await mks.SendEmail(user.Email, body, "Confirm Your Email");
			}
