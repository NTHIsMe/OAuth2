    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnurl=null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
					...
					await mks.SendEmail(model.Email, body, "Confirm Your Account");
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
				...
				await mks.SendEmail(model.Email, body, "Reset your password");
				return RedirectToAction("ForgotPasswordConfirmation");
            }
        ...
        public async Task<IActionResult> EnableAuthenticator()
        {
            ...
            string AuthenticatorUri = string.Format(AuthenticatorUriFormat, _urlEncoder.Encode("MockProject"),
